// Verified Seed & Initial State Fallbacks for Instant Zero-Flash Rendering
...
export const INITIAL_SERVICES = [
  {
    ...
    tech_stack: ["Python", "TypeScript", "Node.js", "PostgreSQL", "Docker", "AWS"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["React", "Next.js", "Node.js", "PostgreSQL", "Stripe", "Redis", "AWS"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["React", "TypeScript", "Tailwind CSS", "Vite", "Next.js", "GraphQL"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["Python", "Flask", "React", "PostgreSQL", "MySQL", "Tailwind CSS"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["AWS", "Docker", "Kubernetes", "Terraform", "GitHub Actions", "Prometheus"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["Playwright", "Jest", "PyTest", "Postman", "K6", "SonarQube"],
    faq: [
  ...
  },
  {
    ...
    tech_stack: ["Node.js", "Python", "RabbitMQ", "Redis", "Kafka", "AWS SQS"],
    faq: [
...
export const INITIAL_CASE_STUDIES = [
  {
    ...
    technologies: ["Python", "Flask", "MySQL", "JavaScript", "AWS", "Docker"],
...
Focus on clean relational modeling, transactional consistency, and observable telemetry before introducing distributed complexity.`,
    ...
    tags: ["Architecture", "Backend", "System Design", "Engineering"],
    status: "PUBLISHED",
