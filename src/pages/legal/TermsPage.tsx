    ...
    <div className="pt-28 sm:pt-36 pb-24 bg-[#F8F5EE] min-h-screen select-none">
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8">
        ...
        <div className="p-8 sm:p-12 bg-[#FFFFFF] border border-[#DED7C9] shadow-[0_12px_40px_rgba(14,23,32,0.06)] space-y-8 font-sans text-sm text-[#394352] font-light leading-relaxed">
          <section>
            <h2 className="font-editorial text-2xl text-[#17202B] mb-3">1. Engagement Structure</h2>
            <p>
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#17202B] mb-3">2. Ownership of Deliverables</h2>
            <p>
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#17202B] mb-3">3. Standard Warranty</h2>
            <p>
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#17202B] mb-3">4. Governing Law</h2>
            <p>
