...
export function ArrowLeft({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Menu({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StarIcon({ size = 18, className = "", fill = "none", ...props }: IconProps & { fill?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AiBurstIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CubeIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CloudIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TwitterIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Play({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Pause({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
